...
// Pointer to the Interrupts in idt_helper.asm
extern void isr0();     // 0x20: IRQ 0: Programmable Interrupt Timer
extern void isr1();     // 0x21: IRQ 1: Keyboard
extern void isr2();     // 0x22: IRQ 2: Cascade (2)
extern void isr3();     // 0x23: IRQ 3: COM2 (If Enabled)
extern void isr4();     // 0x24: IRQ 4: COM1 (If Enabled)
extern void isr5();     // 0x25: IRQ 5: LPT2 (If Enabled)
extern void isr6();     // 0x26: IRQ 6: Floppy Disk
extern void isr7();     // 0x27: IRQ 7: LPT1/Spurious Interrupt
extern void isr8();     // 0x28: IRQ 8: CMOS Real-Time Clock
extern void isr9();     // 0x29: IRQ 9: Free for peripherals/legacy SCSI
...
extern void isr128();   // 0x80: IRQ 128: System Call
